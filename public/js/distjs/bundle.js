    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlert)("error", "ERROR: ".concat(_t2.response.data.message));
        case 3:
...
var displayMap = exports.displayMap = function displayMap(locations, maptilerKey) {
  var centerCoord = [locations[0].coordinates[1], locations[0].coordinates[0]];
  var map = L.map("map", {
    scrollWheelZoom: false,
    doubleClickZoom: false,
    touchZoom: false
  }).setView(centerCoord, 13);
  L.tileLayer("https://api.maptiler.com/maps/ch-swisstopo-lbm/{z}/{x}/{y}.jpg?key=".concat(maptilerKey), {
    attribution: '&copy; <a href="http://www.maptiler.com">Maptiler</a>'
  }).addTo(map);
  var myIcon = L.icon({
    iconUrl: "/img/pin.png",
    iconSize: [25, 33],
  ...
  locations.forEach(function (loc) {
    ...
    })).setPopupContent("Day ".concat(loc.day, ": ").concat(loc.description)).openPopup();
    // map.setView([locations[1].coordinates[1], locations[1].coordinates[0]], 9)
  });
  var bounds = L.latLngBounds(myLatLng);
